...
var Select = /** @class */ (function (_super) {
    ...
    function Select(props, context) {
        ...
        _this.handleQueryChange = function (event) {
            ...
            core_1.Utils.safeInvoke(onQueryChange, query);
        };
    ...
    Select.prototype.maybeRenderInputClearButton = function () {
        return this.state.query.length === 0 ? (undefined) : (React.createElement(core_1.Button, { icon: "cross", minimal: true, onClick: this.resetQuery }));
    };
